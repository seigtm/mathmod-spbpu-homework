...
1. numerical_integration - Переход от передаточной функции к
    Дифференциальному уравнению и его решение методом Эйлера
...
def numerical_integration(step,
    ...
    # Объявление значений из первой работы.
    b2 = 3.0
    x_t = 5.0
    k = 4.0
    a1 = 3.0
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=2) as _:
        # Находим минимум функции с приближенными значениями b1 и b3.
